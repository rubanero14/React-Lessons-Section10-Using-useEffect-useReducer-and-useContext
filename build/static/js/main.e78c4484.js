/*! For license information please see main.e78c4484.js.LICENSE.txt */
!(function () {
  "use strict";
  var e = {
      463: function (e, n, t) {
        ...
        function cs(e) {
          ...
          try {
            ...
            (wn = r), (Ni.transition = t), 0 === (6 & (Pi = n)) && Bl();
          }
        }
        function fs() {
          (Ri = Oi.current), _l(Oi);
  ...
  !(function () {
    ...
    var c = "Card_card__SyCzv",
      f = t(184),
      d = function (e) {
        return (0, f.jsx)("div", {
          className: "".concat(c, " ").concat(e.className),
          children: e.children,
        });
      },
      p = "Button_button__rM9+L",
      m = function (n) {
        return (0, f.jsxs)(e.Fragment, {
          children: [
            ...
            "link" !== n.type &&
              (0, f.jsx)("button", {
                type: n.type || "button",
                className: "".concat(p, " ").concat(n.className),
                onClick: n.onClick,
                disabled: n.disabled,
                title: n.title,
                children: n.children,
      ...
      v = function (n) {
        return (0, f.jsx)(e.Fragment, {
          children: (0, f.jsx)("svg", {
            ...
            viewBox: n.viewBox,
            children: (0, f.jsx)("path", { d: n.d }),
          }),
        });
      },
      g = "Input_control__j7nyK",
      y = "Input_invalid__eQEEg",
      b = e.forwardRef(function (n, t) {
        var r = (0, e.useRef)(),
          l = function () {
            r.current.focus();
          };
        return (
          ...
          (0, f.jsxs)("div", {
            className: "".concat(g, " ").concat(n.isValid ? y : ""),
            children: [
              (0, f.jsx)("label", { htmlFor: n.inputType, children: n.label }),
              (0, f.jsx)("input", {
                ref: r,
                type: n.inputType,
                id: n.inputType,
              ...
              n.validator && (0, f.jsx)("p", { children: n.validatorMessage }),
            ],
          })
        );
      }),
      w = { login: "Login_login__HBz5X", actions: "Login_actions__NrowP" },
      k = e.createContext({
        isLoggedIn: !1,
        onLogout: function () {},
      ...
      S = function (n) {
        ...
        (0, e.useEffect)(function () {
          "yes" === localStorage.getItem("login") &&
            (a(!0),
        ...
        return (
          (0, e.useEffect)(
            function () {
              if ("" !== u) {
                var e = u.split("@")[0].replaceAll(/[^\w|^\d]/gi, " ");
                h(
          ...
          (0, f.jsx)(k.Provider, {
            value: {
              isLoggedIn: r,
              onLogout: function () {
                localStorage.setItem("login", "no"), a(!1);
              },
              onLogin: function (e, n) {
        ...
        switch (n.type) {
          case "EMAIL_INPUT":
            return s(
              s({}, e),
              {},
              { email: { val: n.val, isValid: E.test(n.val) } }
            );
          case "PASSWORD_INPUT":
            return s(
              s({}, e),
      ...
      N = function (n) {
        var t,
          r,
          a = l((0, e.useReducer)(C, _.login), 2),
          o = a[0],
          u = a[1],
          i = (0, e.useContext)(x),
          s = (0, e.useRef)(),
        ...
        return (0, f.jsx)(d, {
          ...
          children: (0, f.jsxs)("form", {
            onSubmit: function (e) {
              e.preventDefault(),
                o.password.isValid && o.email.isValid
                  ? i.onLogin(o.email.val, o.password.val)
                  : o.email.isValid
                  ? c.current.focusInput()
                  : s.current.focusInput();
            },
            children: [
              (0, f.jsx)(b, {
                inputType: "email",
                id: "email",
                value: null !== (t = o.email.val) && void 0 !== t ? t : i.email,
                onChange: function (e) {
                  u({ type: "EMAIL_INPUT", val: e.target.value });
                },
                onBlur: function () {
                  u({ type: "EMAIL_BLUR" });
                },
                validator: !o.email.isValid,
                isValid: !o.email.isValid,
                label: "E-Mail",
              ...
              (0, f.jsx)(b, {
                ...
                id: "password",
                value:
                  null !== (r = o.password.val) && void 0 !== r
                    ? r
                    : i.password,
                onChange: function (e) {
                  u({ type: "PASSWORD_INPUT", val: e.target.value });
                },
                onBlur: function () {
                  u({ type: "PASSWORD_BLUR" });
                },
                validator: !o.password.isValid,
                isValid: !o.password.isValid,
                label: "Password",
                validatorMessage:
                  "Please input valid password with minimum 6 characters!",
                ref: c,
              }),
              (0, f.jsxs)("div", {
                className: w.actions,
                children: [
                  ...
                  (0, f.jsxs)(m, {
                    ...
                    className: w.btn,
                    onClick: function () {
                      u({ type: "PASSWORD_INPUT", val: "" }),
                        u({ type: "EMAIL_INPUT", val: "" });
                    },
      ...
      P = "ButtonList_buttonList__ARAC2",
      z = function (e) {
        return (0, f.jsx)("ul", {
          className: P,
          children: e.lists.map(function (e) {
            return (0,
            f.jsx)("li", { id: e.id, children: (0, f.jsx)(m, { type: "link", href: e.href, title: "Link to official doc on learning " + e.btnContent, children: (0, f.jsx)("code", { children: e.btnContent }) }) }, e.id);
          }),
        });
      },
      L = "Home_home__oF389";
    ...
    (R.BASE_URL = "https://beta.reactjs.org/reference/react/"),
      (R.listData = []);
    var O = function () {
        (0, e.useEffect)(function () {
          R.createNewList([
        ...
        return (0, f.jsxs)(d, {
          className: L,
          children: [
            (0, f.jsxs)("h1", { children: ["Welcome back ", n.name, "!"] }),
            (0, f.jsx)("br", {}),
            (0, f.jsx)("h2", {
              style: { fontWeight: "bold" },
              children: "Lets learn about React Hooks",
            }),
            (0, f.jsx)("hr", {}),
            (0, f.jsx)(z, { lists: R.listData }),
            (0, f.jsx)("hr", {}),
            (0, f.jsxs)(m, {
              ...
              children: [
                ...
                (0, f.jsx)("span", { children: "Logout" }),
              ],
            }),
          ],
        });
      },
      M = "Navigation_nav__7z-T5",
      I = function () {
        var n = (0, e.useContext)(x);
        return (0, f.jsx)("nav", {
          className: M,
      ...
      D = {
        "main-header": "MainHeader_main-header__ebSa3",
        rotate: "MainHeader_rotate__0430B",
      },
      F = function () {
        return (0, f.jsxs)("header", {
          className: D["main-header"],
          children: [
            (0, f.jsxs)("h1", {
              children: [
                (0, f.jsx)("span", { children: "React Hooks \xa0" }),
                (0, f.jsx)(v, {
                  className: D["react-logo"],
                  viewBox: "0 0 512 512",
      ...
      j = function () {
        ...
        return (0, f.jsxs)(e.Fragment, {
          children: [
            ...
            (0, f.jsxs)("main", {
              children: [
                !n.isLoggedIn && (0, f.jsx)(N, {}),
                n.isLoggedIn && (0, f.jsx)(O, {}),
              ],
            }),
          ],
        });
    ...
    n.createRoot(document.getElementById("root")).render(
      (0, f.jsx)(S, { children: (0, f.jsx)(j, {}) })
    );
  })();
})();
//# sourceMappingURL=main.e78c4484.js.map
